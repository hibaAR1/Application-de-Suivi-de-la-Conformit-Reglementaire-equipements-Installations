// Page de détail équipement autonome (n'est reliée à aucune route dans
// App.jsx actuellement) — remplacée en pratique par FicheTechniqueModal
// (même contenu, affiché en fenêtre modale). Gardée ici au cas où une
// vraie page dédiée (avec sa propre URL, partageable) serait souhaitée
// plus tard.
import { useParams, useNavigate } from "react-router-dom";
import Plate from "../../components/Plate";
import Badge from "../../components/Badge";
import QRVisual from "../scan/QRVisual";
